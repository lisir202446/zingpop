...
export const formError = {
  ...
  invalidPhoneOrPassword: "error.invalidPhoneOrPassword",
  phoneAlreadyRegistered: "error.phoneAlreadyRegistered",
  passwordLoginLocked: "error.passwordLoginLocked",
  authServiceUnavailable: "error.authServiceUnavailable",
...
const map = {
  ...
  [formError.passwordRequired]: "error.passwordRequired",
  [formError.passwordTooShort]: "error.passwordTooShort",
  [formError.passwordTooLong]: "error.passwordTooLong",
  [formError.passwordMismatch]: "error.passwordMismatch",
  [formError.invalidPhoneOrPassword]: "error.invalidPhoneOrPassword",
  [formError.phoneAlreadyRegistered]: "error.phoneAlreadyRegistered",
  [formError.passwordLoginLocked]: "error.passwordLoginLocked",
  [formError.authServiceUnavailable]: "error.authServiceUnavailable",
  ...
  "Password is required": "error.passwordRequired",
  "Password must be at least 8 characters": "error.passwordTooShort",
  "Password must be 128 characters or less": "error.passwordTooLong",
  "Passwords do not match": "error.passwordMismatch",
  "Invalid phone number or password": "error.invalidPhoneOrPassword",
  "Phone number already registered": "error.phoneAlreadyRegistered",
  "Too many password attempts. Please try again later": "error.passwordLoginLocked",
