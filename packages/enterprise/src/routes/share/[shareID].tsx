          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Zingpop</Title>
              </Show>
              <Meta name="description" content="Zingpop - The AI coding agent built for the terminal." />
